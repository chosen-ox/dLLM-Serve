...
def main():
    ...
    print("Initializing the LLM engine for LLaDA...")
    ...
    prompts = [
        "What is the LLaDA model and how does it differ from autoregressive models like GPT?",
        "Write a short, four-line poem about the quiet of a library at night.",
        "Explain the concept of Classifier-Free Guidance in diffusion models in simple terms.",
    ]
    ...
    print("Applying chat template for LLaDA-Instruct...")
    formatted_prompts = [
